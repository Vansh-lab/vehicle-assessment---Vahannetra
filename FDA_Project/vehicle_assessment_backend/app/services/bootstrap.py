...
def _price_band(workshop_type: str, seed: int) -> dict[str, int]:
    ...
    labour = int(
        350
        if workshop_type == "local"
        else 450 if workshop_type == "multi-brand" else 700
    )
    return {
...
def _garage_seed_rows() -> list[dict]:
    rows = [
        # Delhi (5)
        {
            ...
            "address": "Shop 12, Karol Bagh, New Delhi",
            "city": "Delhi",
            "state": "Delhi",
            "pincode": "110005",
            "phone": "+91 9810123456",
            ...
            "rating": 4.6,
            "type": "multi-brand",
            "certs": ["GoMechanic Partner", "MSME Certified"],
            "years": 12,
        },
        {
            "id": "GAR-DEL-002",
            "name": "AutoShield Authorized",
        ...
        },
        {
            ...
            "rating": 4.3,
            "type": "multi-brand",
            "certs": ["GoMechanic Partner"],
            "years": 8,
        },
        {
            "id": "GAR-DEL-005",
            "name": "Metro Car Body Shop",
        ...
        {
            "id": "GAR-KNP-001",
            "name": "Kanpur Car Care Centre",
            "address": "HIG 42-43, Barra 2, Kanpur",
            "city": "Kanpur",
            "state": "Uttar Pradesh",
            "pincode": "208027",
            "phone": "+91 9555011001",
        ...
        {
            "id": "GAR-KNP-002",
            "name": "Super Car Automobile",
            "address": "D Block 39, Barra Bypass, Kanpur",
            "city": "Kanpur",
            "state": "Uttar Pradesh",
            "pincode": "208027",
            "phone": "+91 9555011002",
        ...
        {
            "id": "GAR-KNP-003",
            "name": "SK Car Workshop",
            "address": "Plot D-37, Barra 6, Kanpur",
            "city": "Kanpur",
            "state": "Uttar Pradesh",
            "pincode": "208027",
            "phone": "+91 9555011003",
        ...
        {
            "id": "GAR-KNP-004",
            "name": "GoMechanic — Shiv Motors",
            "address": "E-86 MIG Barra, Kanpur",
            "city": "Kanpur",
            "state": "Uttar Pradesh",
            "pincode": "208027",
            "phone": "+91 9555011004",
        ...
        },
        {
            "id": "GAR-KNP-005",
            "name": "Om Auto Centre",
            "address": "30 Karrhi Road, Maya Market, Kanpur",
            "city": "Kanpur",
            "state": "Uttar Pradesh",
            "pincode": "208027",
            "phone": "+91 9555011005",
...
def _insurance_seed_rows() -> list[dict]:
    return [
        {
            "id": "INS-DEL-001",
            "name": "Delhi Claims Desk 1",
            "insurer_name": "ICICI Lombard",
            "address": "Connaught Place, Delhi",
            "city": "Delhi",
            "phone": "+91-1800-100-0001",
            "toll_free": "1800-100-0001",
            "latitude": 28.6315,
            "longitude": 77.2167,
            "rating": 4.3,
        },
        {
            "id": "INS-DEL-002",
            "name": "Delhi Claims Desk 2",
            "insurer_name": "Bajaj Allianz",
            "address": "Karol Bagh, Delhi",
            "city": "Delhi",
            "phone": "+91-1800-100-0002",
            "toll_free": "1800-100-0002",
            "latitude": 28.6519,
            "longitude": 77.1909,
            "rating": 4.1,
        },
        {
            "id": "INS-MUM-001",
            "name": "Mumbai Claims Hub 1",
            "insurer_name": "HDFC Ergo",
            "address": "BKC, Mumbai",
            "city": "Mumbai",
            "phone": "+91-1800-100-0011",
            "toll_free": "1800-100-0011",
            "latitude": 19.0707,
            "longitude": 72.8697,
            "rating": 4.2,
        },
        {
            "id": "INS-MUM-002",
            "name": "Mumbai Claims Hub 2",
            "insurer_name": "TATA AIG",
            "address": "Andheri, Mumbai",
            "city": "Mumbai",
            "phone": "+91-1800-100-0012",
            "toll_free": "1800-100-0012",
            "latitude": 19.1136,
            "longitude": 72.8697,
            "rating": 4.0,
        },
        {
            "id": "INS-BLR-001",
            "name": "Bengaluru Claim Point 1",
            "insurer_name": "ICICI Lombard",
            "address": "Indiranagar, Bengaluru",
            "city": "Bengaluru",
            "phone": "+91-1800-100-0021",
            "toll_free": "1800-100-0021",
            "latitude": 12.9719,
            "longitude": 77.6412,
            "rating": 4.3,
        },
        {
            "id": "INS-BLR-002",
            "name": "Bengaluru Claim Point 2",
            "insurer_name": "Bajaj Allianz",
            "address": "HSR Layout, Bengaluru",
            "city": "Bengaluru",
            "phone": "+91-1800-100-0022",
            "toll_free": "1800-100-0022",
            "latitude": 12.9116,
            "longitude": 77.6474,
            "rating": 4.2,
        },
        {
            "id": "INS-KNP-001",
            "name": "Kanpur Insurance Center 1",
            "insurer_name": "New India Assurance",
            "address": "Civil Lines, Kanpur",
            "city": "Kanpur",
            "phone": "+91-1800-100-0031",
            "toll_free": "1800-100-0031",
            "latitude": 26.4499,
            "longitude": 80.3319,
            "rating": 4.1,
        },
        {
            "id": "INS-KNP-002",
            "name": "Kanpur Insurance Center 2",
            "insurer_name": "HDFC Ergo",
            "address": "Swaroop Nagar, Kanpur",
            "city": "Kanpur",
            "phone": "+91-1800-100-0032",
            "toll_free": "1800-100-0032",
            "latitude": 26.4798,
            "longitude": 80.3153,
            "rating": 4.0,
        },
        {
            "id": "INS-HYD-001",
            "name": "Hyderabad Claim Desk 1",
            "insurer_name": "ICICI Lombard",
            "address": "Banjara Hills, Hyderabad",
            "city": "Hyderabad",
            "phone": "+91-1800-100-0041",
            "toll_free": "1800-100-0041",
            "latitude": 17.4126,
            "longitude": 78.4482,
            "rating": 4.2,
        },
        {
            "id": "INS-HYD-002",
            "name": "Hyderabad Claim Desk 2",
            "insurer_name": "Bajaj Allianz",
            "address": "Madhapur, Hyderabad",
            "city": "Hyderabad",
            "phone": "+91-1800-100-0042",
            "toll_free": "1800-100-0042",
            "latitude": 17.4448,
            "longitude": 78.3915,
            "rating": 4.1,
        },
        {
            "id": "INS-PUN-001",
            "name": "Pune Claims Help",
            "insurer_name": "HDFC Ergo",
            "address": "Baner, Pune",
            "city": "Pune",
            "phone": "+91-1800-100-0051",
            "toll_free": "1800-100-0051",
            "latitude": 18.5590,
            "longitude": 73.7868,
            "rating": 4.2,
        },
        {
            "id": "INS-PUN-002",
            "name": "Pune Policy Desk",
            "insurer_name": "TATA AIG",
            "address": "Kothrud, Pune",
            "city": "Pune",
            "phone": "+91-1800-100-0052",
            "toll_free": "1800-100-0052",
            "latitude": 18.5074,
            "longitude": 73.8077,
            "rating": 4.0,
        },
        {
            "id": "INS-CHE-001",
            "name": "Chennai Claims Point",
            "insurer_name": "ICICI Lombard",
            "address": "Anna Salai, Chennai",
            "city": "Chennai",
            "phone": "+91-1800-100-0061",
            "toll_free": "1800-100-0061",
            "latitude": 13.0618,
            "longitude": 80.2742,
            "rating": 4.2,
        },
        {
            "id": "INS-CHE-002",
            "name": "Chennai Insurance Hub",
            "insurer_name": "Bajaj Allianz",
            "address": "Velachery, Chennai",
            "city": "Chennai",
            "phone": "+91-1800-100-0062",
            "toll_free": "1800-100-0062",
            "latitude": 12.9753,
            "longitude": 80.2204,
            "rating": 4.1,
        },
        {
            "id": "INS-KOL-001",
            "name": "Kolkata Claim Support",
            "insurer_name": "New India Assurance",
            "address": "Salt Lake, Kolkata",
            "city": "Kolkata",
            "phone": "+91-1800-100-0071",
            "toll_free": "1800-100-0071",
            "latitude": 22.5755,
            "longitude": 88.4325,
            "rating": 4.1,
        },
